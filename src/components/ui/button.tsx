...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 disabled:text-neutral-300 border-neutral-200",
  {
    variants: {
      variant: {
        primary:
        ...
        secondary:
          "bg-white text-black hover:bg-neutral-100 border",
